                    ...
                    <form method="POST" action="{{ route('partners.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="type" name="type" required 
                                ...
                                <option value="collaborator" {{ old('type', 'collaborator') == 'collaborator' ? 'selected' : '' }}>Cộng tác viên</option>
                                <option value="maintenance" {{ old('type') == 'maintenance' ? 'selected' : '' }}>Đối tác bảo trì</option>
                            </select>
                            @error('type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" id="commission_rate" name="commission_rate" value="{{ old('commission_rate') }}" step="1" min="0" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
