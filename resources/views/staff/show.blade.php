            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        @can('manage settings')
                        <a href="{{ route('assets.create', ['usage_type' => 'staff', 'staff_id' => $staff->id]) }}" class="px-4 py-2 bg-green-600 text-white text-sm rounded-md hover:bg-green-700">
                            + Thêm tài sản
                        </a>
                        @endcan
                    </div>

                    @if($staff->assets->isEmpty())
                        <p class="text-gray-500 text-center py-8">Chưa có tài sản nào được gán cho nhân viên này</p>
                    @else
                        ...
                        <div class="mt-4 text-sm text-gray-600">
                            <strong>Tổng số tài sản:</strong> {{ $staff->assets->count() }} | 
                            <strong>Tổng số lượng:</strong> {{ $staff->assets->sum('quantity') }}
                        </div>
                    @endif
                </div>
            </div>
