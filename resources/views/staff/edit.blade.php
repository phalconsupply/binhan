                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="staff_type" name="staff_type" required 
                                        ...
                                        <option value="vehicle_owner" {{ old('staff_type', $staff->staff_type) == 'vehicle_owner' ? 'selected' : '' }}>Chủ xe</option>
                                ...
                                <div x-show="staffType === 'vehicle_owner'" x-cloak>
                                    ...
                                    <select id="vehicle_id" name="vehicle_id" 
                                        ...
                                        @foreach(\App\Models\Vehicle::orderBy('license_plate')->get() as $vehicle)
                                            <option value="{{ $vehicle->id }}" {{ old('vehicle_id', $staff->vehicle_id) == $vehicle->id ? 'selected' : '' }}>
